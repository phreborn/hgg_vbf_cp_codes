...
g++ -I. `root-config --cflags --libs` -I/cvmfs/sft.cern.ch/lcg/releases/LCG_97a/vdt/0.4.3/x86_64-centos7-gcc8-opt/include/ -o getMag_w1.exe getMag_w1.cxx
chmod +x getMag_w1.exe
