...
declare -A mapCtrType=(["EG"]="logn" ["PH"]="logn" ["FT"]="asym" ["JET"]="asym" ["MET"]="asym" ["PRW"]="asym" ["pdf"]="logn" ["qcd"]="logn" ["alphaS"]="logn" ["shower"]="gaus" ["rest_Higgs"]="gaus" ["mcstat"]="logn")
echo ${!mapCtrType[*]}

cats=$(cat ../../nom_WS/cats.cfg | grep -v "#" | grep ":" | cut -d ":" -f 1)
d_tilde=$(ls ${basepath}/csv/ | grep b3 | grep -v SM | grep TT | cut -d '_' -f 4)
