...
//    lg->AddEntry(rhv_stat, "stat. uncer.", "f");
    ...
    for(auto b : bins){
      ...
      int bnum = b.first;
      rhv->GetXaxis()->SetBinLabel(bnum, bname);
    }

    canv->SaveAs("sketch_oobinning_"+cat+".png");
  }
}
